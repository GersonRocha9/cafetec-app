  ...
  public: {
    Tables: {
      ...
      coffees: {
        ...
        Relationships: [
          {
            foreignKeyName: 'coffees_property_id_fkey'
            columns: ['property_id']
            isOneToOne: false
            referencedRelation: 'properties'
            referencedColumns: ['id']
      ...
      plots: {
        ...
        Relationships: [
          {
            foreignKeyName: 'plots_coffee_id_fkey'
            columns: ['coffee_id']
            isOneToOne: false
      ...
      production_data: {
        Row: {
          ...
          id: string
          plot_id: string
          production_per_hectare: number | null
        ...
        Relationships: [
          {
            foreignKeyName: 'production_data_plot_id_fkey'
            columns: ['plot_id']
            isOneToOne: false
            referencedRelation: 'plots'
            referencedColumns: ['id']
      ...
      sales: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'sales_coffee_id_fkey'
            columns: ['coffee_id']
            isOneToOne: false
            referencedRelation: 'coffees'
            referencedColumns: ['id']
    ...
    Functions: {
      ...
      calculate_distance: {
        Args: { p_property_id1: string; p_property_id2: string }
        Returns: number
      }
      ...
      update_overdue_accounts: { Args: never; Returns: undefined }
      updategeometrysrid: {
        Args: {
